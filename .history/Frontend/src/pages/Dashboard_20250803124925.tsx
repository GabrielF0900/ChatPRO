    ...
    const connectWebSocket = () => {
      try {
        ...
        ws.onmessage = async (event) => {
          console.log('🔔 Mensagem recebida de outro usuário');
          try {
            let messageData;
            ...
            console.log('📋 Dados da mensagem:', {
              ...
              userEmail: userEmail,
              saoIguais: data.senderId === userEmail,
              messageId: data.id
            });
            ...
            if (data.senderId === userEmail) {
              console.log('⚠️ Minha própria mensagem retornando, ignorando');
              console.log('🔍 Debug:', { 
                dataSenderId: data.senderId, 
                myUserEmail: userEmail,
                areEqual: data.senderId === userEmail 
              });
              return;
            }
            ...
            console.log('✅ Nova mensagem adicionada de:', data.user);
