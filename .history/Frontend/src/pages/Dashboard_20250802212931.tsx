        ...
        >
          <div className="flex gap-3 items-end">
            <div className="flex-1 relative">
              ...
              <div className="text-xs text-gray-400 mt-2">0/1000 caracteres</div>
            </div>
            <button
              type="submit"
              className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-2xl font-medium transition-colors duration-200 flex items-center gap-2"
            >
